...
const uri = process.env.MONGODB_URL || `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@orange2.mefkcm6.mongodb.net/${process.env.MONGO_DB}?retryWrites=true&w=majority`;
